/* from https://github.com/nicolaskruchten/pivottable/blob/master/dist/c3_renderers.js master on 5/15/16 */
(function() {
  var callWithJQuery;
    ...
    makeC3Chart = function(chartOpts) {
      ...
      return function(pivotData, opts) {
        ...
        if ((base1 = opts.c3.size).width == null) {
          base1.width = $(".chart").first().width() //window.innerWidth / 1.4;
        }
        if ((base2 = opts.c3.size).height == null) {
          base2.height = $(".chart").first().height() //// window.innerHeight / 1.4 - 50;
        }
